...
import arrow
from PyQt5.QtCore import Qt, QThread, pyqtSignal, QTimer, QItemSelection, \
    QItemSelectionModel
from PyQt5.QtWidgets import QTabWidget, QGroupBox, QGridLayout, QTableWidget, \
    QAbstractItemView, QPushButton, QCheckBox, QLabel, QLineEdit, QApplication, \
    QStyle, QWidget, QSizePolicy, QHBoxLayout, QSpinBox, QProgressBar, \
